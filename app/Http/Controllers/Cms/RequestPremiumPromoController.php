...
class RequestPremiumPromoController extends BaseController
{
    // init
    ...
    public function index()
    {
        ...
        //generate view
        $view_source                            = $this->view_root . '.promo.request_premium.index';
    ...
    public function search(){
        $search_result                          = Products::where('is_premium', null)
                                                    ->orWhere('is_premium', false)
                                                    ->where('bukti_pembayaran', '!=', null)
