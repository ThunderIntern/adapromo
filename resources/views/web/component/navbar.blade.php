...
<nav class="navbar navbar-light bg-faded" style="line-height: 50px;">
    ...
    <div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar2">
        ...
        <li class="nav-item <?php if(Request::segment(1)=='promo') echo 'active'; ?>">
  				<a class="nav-link dark-text m-r-2 p-b-0 w-100" href="{{route('promo')}}">PROMO</a>
  			</li>
        -->
        <li class="nav-item dropdown <?php if(Request::segment(1)=='promo') echo 'active'; ?>">
          <a class="nav-link dropdown-toggle dark-text m-r-2 p-b-0 w-100" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><strong>PROMO</strong></a>
        ...
        @if(Session::has('user'))
        <li class="nav-item">
          <a class="nav-link dark-text m-r-2 p-b-0 w-100" href="{{route('account')}}"><strong><i class="fa fa-user"></i></strong></a>
        </li>
        <li class="nav-item">
