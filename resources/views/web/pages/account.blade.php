                            ...
                            <div class="tab-content">
                              <div class="tab-pane active p-b-2" id="account" role="tabpanel">
                                <h3 class="text-xs-left m-t-2 dark-blue-text">Account Setting</h3>
                                  {!! Form::open(['url' => route('account_setting'), 'method' => 'post', 'class' => 'text-xs-left']) !!}
                                    ...
                                    {!! Form::text('dob', $page_attributes->detail['dob'], ['class' => 'form-control icon-awesome-placeholder', 'placeholder' => 'Date of Birth', 'data-inputmask' => "'mask':'m/d/y'", 'required' => 'required']) !!}
                                    {!! Form::submit('Save', ['class' => 'btn btn-block dark-blue white-text m-t-1', 'onClick' => 
                                        "if((this.form.dob.value).search('_')<0){
