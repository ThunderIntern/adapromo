					...
					@forelse ($page_datas->datas as $key => $data)
						<tr>
							...
							<td class="col-md-4 text-xs-right">
								<a href="{{route('cms.promo.premium.accept', ['id' => $data['id']])}}" class="btn btn-primary btn-sm" title="Add to Premium Promo" onclick="return confirm('Yakin ingin menambahkan promo ini sebagai premium promo?');">
