...
<body>
	<div style="width:100%">
		<div style="width:50%; float:left;">
			<img src="adapromologo.png" style="width:100%;" alt="logo adapromo">
		</div>
	...
	<div style="width:100%">
		...
		<div style="width:40%;float:left; font-size:10px;text-align:center;">Untuk berhenti berlangganan, silahkan klik <a href="http://localhost:8000/unsubscribe/{{ $code_unsubscribe }}">disini</a>.</div>
