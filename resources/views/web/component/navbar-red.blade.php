        ...
        <div class="container-fluid">
    		<div class="row">
                <div class="navbar-red">
        			...
        			<div class="col-md-10">
        				<div class="col-md-12">
        					<img src="{{ url('adapromologo-white.png') }}"/>
        						<b>
        						<nav class="navbar navbar-light" style="float:right">
        						  ...
        						  <div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar2">
        						    <ul class="nav navbar-nav">
        						      ...
        						      <li class="nav-item">
        						        <a class="nav-link white" href="#">PROMO</a>
        						      </li>
        						      <li class="nav-item">
        						        <a class="nav-link white" href="#">SIGN UP / SIGN IN</a>
        						      </li>
        						      <li class="nav-item menu-last">
        						        <a class="nav-link white" href="#">CONTACT US</a>
        						      </li>
        						    </ul>
        						  </div>
        						</nav>
